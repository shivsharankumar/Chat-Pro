...
from app.vectorstore_utils import create_faiss_index, retrieve_relevant_documents
...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">?AskDoc Pro</h1>
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                relevant_docs = retrieve_relevant_documents(st.session_state.vectorstore, prompt)
